...
print("path-filterのURLをクリップボードにコピーして、Enterキーを押してください")
print("Copy the path-filter URL to the clipboard and press Enter.")
# print("")
...
print("path-uniqueのURLをクリップボードにコピーして、Enterキーを押してください")
print("Copy the path-unique URL to the clipboard and press Enter.")
# print("")
...
def cutTetfuText(tetfu): #テト譜文字列から「?」や最初部分など、不要な部分を取り除く
    ...
    tetfu = tetfu.replace(os.linesep, "") #改行を取り除く
...
print(f"{repeat_cnt}パターン重複  {repeat_cnt} pattern duplicate")
# print("")
# print(result_URL)
print("")
...
print("クリップボードにコピーされました、Enterキーを押してプログラムを終了させてください")
print("Copied to clipboard, press Enter to exit the program.")
